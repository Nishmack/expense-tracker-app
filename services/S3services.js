...
const uploadToS3 = (data, filename) => {
  ...
  const BUCKET_NAME = "expensetrackerappmain"; //creating bucket called expensetrackingapp554
  ...
  var params = {
    ...
    ACL: "public-read", // Set access permissions for the uploaded object (here public can access the file).access control level.it is publically readable now
  };
